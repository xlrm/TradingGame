...
class ImageList():
    ...
    def IMAGEDIC(self):
        dic={"mainmenu_img" : self.mainmenu_img, 
...
# 버튼
    def BUTTONDIC(self):
        ...
        self.playagain_button= button.Button(300, 550, IMAGES["playagain_img"], 1)
        self.exitgame_button= button.Button(800, 550, IMAGES["exitgame_img"], 1)
        dic={"start_button" : self.start_button,
